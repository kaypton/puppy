...
func TestConfigurationValidate(t *testing.T) {
	...
	cases := []struct {
		...
		{"bare ipv6", Configuration{Enabled: true, ListenAddress: "::1", ListenPort: 8443}, ""},
		{"bracketed ipv6", Configuration{Enabled: true, ListenAddress: "[2001:db8::1]", ListenPort: 8443}, "must not contain brackets"},
	}
