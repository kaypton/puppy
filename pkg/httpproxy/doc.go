// Package httpproxy implements an HTTP CONNECT proxy with optional
// username/password authentication. It is designed as a frontend for pkg/shim:
// after a successful CONNECT handshake, the client connection and a backend
// connection (obtained via a common.Backend) are handed to a ShimServer for
